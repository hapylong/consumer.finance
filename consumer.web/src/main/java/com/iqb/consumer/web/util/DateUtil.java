...
public class DateUtil {
    ...
    public static void main(String[] args) throws ParseException {
        System.out.println(getMonthSpace("20161112", "20170112"));
        // String str = "20160331";
        // SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
        // // Date date = sdf.parse(str);
        // // Calendar calendar = Calendar.getInstance();
        // // calendar.setTime(date);
        // // Calendar afterCal = lastBillDay(calendar);
        // // String dateStr = sdf.format(afterCal.getTime());
        // // System.out.println(dateStr);
        // // BigDecimal freeAmt = new BigDecimal(0);
        // // System.out.println(freeAmt);
        //
        // Date fronter = sdf.parse("20160802");
        // Date later = sdf.parse("20160801");
        // System.out.println(diffDays(fronter, later));
        // System.out.println(addDays(fronter, 1));
        // System.out.println(getDateFromDate(fronter, 1, "yyyyMMdd"));
        // long delayDays = 1;
        //
        // System.out.println(DateUtil.addDayFromDate(fronter, (int) delayDays));
    }
}
