...
import com.iqb.consumer.web.exception.RequestException;
...
public class DecryptUtils {
    ...
    public String DecryptFromRequest(HttpServletRequest request) {
        ...
        try {
            ...
            boolean signFlag = RSAUtils.verify(byteData, paramConfig.getCommonPublicKey(), sign);
            if (signFlag) {
                // 解密
                byte[] decodedData =
                        RSAUtils.decryptByPublicKey(byteData, paramConfig.getCommonPublicKey());
