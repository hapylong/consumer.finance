...
/**
 * See the license below. Obviously, this is not a Javascript credit card number generator. However,
 * The following class is a port of a Javascript credit card number generator.
 * 
 * @author robweber
 * 
 */
public class RandomCreditCardNumberGenerator {
    ...
    /*
     * 'prefix' is the start of the CC number as a string, any number of digits. 'length' is the
     * length of the CC number to generate. Typically 13 or 16
     */
