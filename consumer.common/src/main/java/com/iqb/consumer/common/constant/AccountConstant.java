...
public class AccountConstant {
    ...
    public static final String ERROR = "fail";// 失败
    public static final int STATUS_OK = 1;
    public static final int STATUS_NO = 2;
    /*
     * 订单还款状态 3 全部还款 4 失效账单
     */
    public static final int STATUS_ALLREPAY = 3;
    ...
    public class BillDateConstant {
        ...
        /** 根据传入账单时间动态计算账单日 **/
        public static final String BILLDATE_TYPE_DYNAMIC = "6";
    }
    /** 锁定日期相关 */
