...
var IQB = {
	...
	/*AJAX提交JSON(RESTful风格)*/
	ajaxJson2: function(url, type, async, option, callback){
		$.ajax({
			url: url,
			type: type,
			async: async,
	...
	postJson: function(url, option, callback){
		IQB.ajaxJson2(url, 'post', true, option, function(data){
			if($.isFunction(callback)){
	 			callback(data);
	 		}		
		});
	...
	$.extend({      
			  ...
			  var html = '<div id="confirm-win" class="modal fade" role="dialog" aria-labelledby="confirm-win-label">' + 
								'<div class="modal-dialog modal-sm" role="document">' +
									'<div class="modal-content">' +
								  		'<div class="modal-header"><h5 class="modal-title" id="confirm-win-label">信息确认</h5></div>' +
		  ...
		  initConfirmWin: function(){
			  var html = '<div id="alert-win" class="modal fade" role="dialog" aria-labelledby="alert-win-label">' +
								'<div class="modal-dialog modal-sm" role="document">' +
									'<div class="modal-content">' +
								  		'<div class="modal-header"><h5 class="modal-title" id="alert-win-label">信息提示</h5></div>'	+
