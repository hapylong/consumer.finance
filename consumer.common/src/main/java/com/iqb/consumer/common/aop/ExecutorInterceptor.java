...
import com.iqb.consumer.common.dialect.Dialect;
...
public class ExecutorInterceptor extends AbstractInterceptor {
    ...
    private void processIntercept(final Object[] queryArgs) {
        ...
        if (dialect.supportsLimit() && (offset != RowBounds.NO_ROW_OFFSET || limit != RowBounds.NO_ROW_LIMIT)) {
            ...
            String sql =
                    boundSql.getSql().replaceAll("\\s{2,}", " ").replace(" FROM", " from")
    ...
    public static void main(String[] args) {
        String sql =
                "select temp.* from (select id,var_3 as 'abc', var_4 as 'cde' from  youtable where 1=1 and var_3='1')group by var_3) as temp order by temp.id desc";
