 ...
 * @version V1.0
 */
package com.iqb.consumer.web.exception;
...
public class RequestException extends RuntimeException implements Serializable {
    ...
    public static final RequestException REPAY_VERIFY_EXCEPTION = new RequestException(60010001, "还款合法性验证参数异常解密");
    public static final RequestException REPAY_SIGN_DECRYPTION_EXCEPTION = new RequestException(60010002, "还款合法性验签失败");
    public static final RequestException REPAY_CONVER2BEAN_EXCEPTION = new RequestException(60010003, "还款参数转Bean异常");
    /**
     * 异常信息
     */
