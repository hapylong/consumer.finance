...
public class DateUtil {
    ...
    public static Date getStartDateOfMonth(Calendar c) {
    ...
    public static Date getEndDateOfMonth(Calendar c) {
     ...
     * @param date
     * @param days
     * @return Date Author haojinlong Create Date: 2017年5月10日
     */
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Date start = DateUtil.getEndDateOfMonth(Calendar.getInstance());
        System.out.println(format(start, "yyyy-MM-dd HH:mm:ss"));
    }
