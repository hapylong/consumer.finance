...
public enum BankCode {
    ...
    public static void main(String[] args) {
        System.out.println(getCode("腾付通支付"));
    }
    ...
    public static Map<String, String> getCommonMap() {
        ...
        BankCode[] type =
        {BankCode.CMBCHINA, BankCode.CGB, BankCode.CEB, BankCode.PINGANBANK, BankCode.BOCO, BankCode.POST,
                BankCode.CMBC, BankCode.ECITIC, BankCode.CIB};
        Map<String, String> map = new LinkedHashMap<String, String>();
        if (type != null) {
            for (BankCode e : type) {
                map.put(e.toString(), e.getDesc());
