...
import com.iqb.consumer.common.db.SubDbContextHolder;
...
public abstract class BaseDaoImpl<T extends BaseEntity> extends SqlSessionDaoSupport implements BaseDao<T> {
    ...
    /**
     * 
     * Description:所有查询从slave中获取数据(带条件)
     * 
     * @param objs
     * @param request
     * @return
    ...
    public <E> List<E> selectList(String statement) {
        this.setDb(1, SLAVE);
        List<E> list = getSqlSession().selectList(statement);
        return list;
    }
